...
なお，表示子機のスケッチは親機がNECフォーマットを用いていた時期に作成したものであり，受信の判定もNECのままである．\ref{sec:proto-compare}節で述べた第9週のSony SIRCへの移行に表示子機が追従できておらず，最終構成では表示子機の受信処理をSIRCへ更新する必要がある．この統合上の不整合については\ref{sec:disc-limit}節で改めて述べる．
