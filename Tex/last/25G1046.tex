...
\begin{figure}[H]
	...
	\gantttitle{W10}{3}\\
    %tasks
    \ganttbar[bar/.append style={fill=orange!40}]{110:ピアノ音の作成/櫛濵・久家}{1}{3}
    \ganttbar[bar/.append style={fill=orange!40}]{}{7}{9} \\
    \ganttbar[bar/.append style={fill=orange!40}]{120:通信用関数（ピアノ）/櫛濵・久家}{1}{3} \\
    \ganttbar[bar/.append style={fill=orange!40}]{130:フルート音の作成/家田}{1}{3} \\
    \ganttbar[bar/.append style={fill=orange!40}]{140:通信用関数（フルート）/家田}{1}{3} \\
    \ganttbar[bar/.append style={fill=orange!40}]{150:トランペット音の作成/木下}{1}{3} \\
    \ganttbar[bar/.append style={fill=orange!40}]{160:通信用関数（トランペット）/木下}{1}{3} \\
    \ganttbar[bar/.append style={fill=orange!40}]{170:ドラム音の作成（キック）/久家}{4}{6} \\
    \ganttbar[bar/.append style={fill=orange!40}]{171:ドラム音の作成（シンバル）/久家}{4}{6} \\
    \ganttbar[bar/.append style={fill=orange!40}]{180:通信用関数（ドラム）/久家}{4}{6} \\
    \ganttbar[bar/.append style={fill=green!40}]{210:ピアノのプログラム/櫛濵}{1}{3} \\
    \ganttbar[bar/.append style={fill=green!40}]{220:フルートのプログラム/家田}{1}{3} \\
    \ganttbar[bar/.append style={fill=green!40}]{230:トランペットのプログラム/木下}{1}{3} \\
    \ganttbar[bar/.append style={fill=green!40}]{240:ドラムのプログラム/久家}{4}{6} \\
    \ganttbar[bar/.append style={fill=cyan!40}]{250:楽譜進行/渡邊}{4}{12} \\
    \ganttbar[bar/.append style={fill=cyan!40}]{310:赤外線管理/家田・渡邊}{4}{12} \\
    \ganttbar[bar/.append style={fill=cyan!40}]{320:テンポ管理/渡邊・櫛濵}{4}{6} \\
    \ganttbar[bar/.append style={fill=gray!40}]{410:回路作成/木下・手代木}{4}{6} \\
    \ganttbar[bar/.append style={fill=gray!40}]{420:LEDマトリクス作成/手代木}{4}{12} \\
    \ganttbar[bar/.append style={fill=blue!40}]{510:結合テスト/全員}{10}{18}
    \end{ganttchart}
    \end{center}
    \caption{開発スケジュール}
	\label{fig:gantt}
...
\bibitem{nishiguchi} 西口磯春，``ピアノの音響とその物理モデル,'' RISTニュース，No.56，pp.3--15，2014.
